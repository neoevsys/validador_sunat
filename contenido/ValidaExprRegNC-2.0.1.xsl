...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" 
  ...
  <!-- key identificador de forma de pago duplicadas -->
	...
	<xsl:template match="/*">
		...
		<!-- MIGE-Factoring Variable para controlar activacion de validaciones --> 
      ...
      <!--Versión 5 excel -->
		...
		<!-- PAS20211U210700045 - Validacion temporal, para que no permita el ingreso de la nota tipo 13, sin retirar del catalogo. Eliminar luego -->
    ...
    <!-- PAS20211U210700059 - Excel v7 -->
		<xsl:if test="cac:DiscrepancyResponse/cbc:ResponseCode[text()='04' or text()='05' or text()='08']">
       <xsl:call-template name="isTrueExpresion">
         <xsl:with-param name="errorCodeValidate" select="'4367'" />
         <xsl:with-param name="node" select="cac:DiscrepancyResponse/cbc:ResponseCode" />
         <xsl:with-param name="expresion" select="count(cac:BillingReference/cac:InvoiceDocumentReference/cbc:DocumentTypeCode[text() = '03']) &gt; 0" />
         <xsl:with-param name="isError" select ="false()"/>
       </xsl:call-template>
    </xsl:if>   
        ...
        <xsl:call-template name="existAndRegexpValidateElement">
            ...
            <xsl:with-param name="regexp" select="'^(?!\s*$).{0,499}$'"/>
    ...
    <!-- PAS20211U210700059 - Excel v7 - Se agrega validacion ERR-3315, la nota debe tener monto cero para el tipo 13-->
    <xsl:if test="cac:DiscrepancyResponse/cbc:ResponseCode = '13'">
     	 <xsl:call-template name="isTrueExpresion">
        ...
        ERROR   2065
        -->
        <!-- Versión 5 excel Se comenta esta validacion -->
    ...
    *******************************************************************************************************************************************
	...
	<xsl:template match="cac:AccountingCustomerParty">
	    ...
	    <!-- Descomentado if PAS20191U210100194 JOH -->
     ...
     <!-- /CreditNote/cac:DiscrepancyResponse/cbc:ResponseCode Si tipo de nota de credito es diferente de 10-Otros, y NO existe un tag /CreditNote/cac:BillingReference/
      ...
      <!--Versión 5 excel -->
			<!--xsl:when test="$root/cac:DiscrepancyResponse/cbc:ResponseCode = '10'">
				...
				<xsl:if test="string(cac:InvoiceDocumentReference/cbc:ID)">
					<xsl:call-template name="existAndRegexpValidateElement">
   ...
   <xsl:choose>
     <xsl:when test="$root/cac:DiscrepancyResponse/cbc:ResponseCode = '10'">
				<!-- /CreditNote/cac:BillingReference/cbc:InvoiceDocumentReference/cbc:DocumentTypeCode Si "Código de tipo de nota de crédito" es igual a "10" (Otros conceptos) y la Serie del comprobante empieza con "B":
				ERROR 2399 -->
				...
				<!-- /CreditNote/cac:BillingReference/InvoiceDocumentReference/cbc:DocumentTypeCode Si "Código de tipo de nota de crédito" es igual a "10" (Otros conceptos) y la Serie del comprobante empieza con "F":
				ERROR 2116 -->
				<xsl:if test="substring($root/cbc:ID, 1, 1) = 'F'">
					<xsl:call-template name="isTrueExpresion">
						<xsl:with-param name="errorCodeValidate" select="'2116'" />
						<xsl:with-param name="node" select="cac:InvoiceDocumentReference/cbc:DocumentTypeCode" />
						<xsl:with-param name="expresion" select="cac:InvoiceDocumentReference/cbc:DocumentTypeCode[text() !='01' and text() !='05' and text() !='06' and text() !='12' and text() !='12' and text() !='13' and text() !='15' and text() !='16' and text() !='18' and text() !='21' and text() !='28' and text() !='30' and text() !='34' and text() !='37' and text() !='42' and text() !='43' and text() !='45' and text() !='55' and text() !='11' and text() !='17' and text() !='23' and text() !='24' and text() !='56' and text() !='-' and text() !='']" />					
          </xsl:call-template>
				</xsl:if>

				<!-- /CreditNote/cac:BillingReference/InvoiceDocumentReference/cbc:DocumentTypeCode Si "Código de tipo de nota de crédito" es igual a "10" (Otros conceptos) y la Serie del comprobante empieza con número:
				ERROR 2594 -->
				<xsl:if test="substring($root/cbc:ID, 1, 1) = '0' or substring($root/cbc:ID, 1, 1) = '1' or substring($root/cbc:ID, 1, 1) = '2' or substring($root/cbc:ID, 1, 1) = '3' or substring($root/cbc:ID, 1, 1) = '4' or substring($root/cbc:ID, 1, 1) = '5' or substring($root/cbc:ID, 1, 1) = '6' or substring($root/cbc:ID, 1, 1) = '7' or substring($root/cbc:ID, 1, 1) = '8' or substring($root/cbc:ID, 1, 1) = '9'">
					<xsl:call-template name="isTrueExpresion">
						...
						<xsl:with-param name="node" select="cac:InvoiceDocumentReference/cbc:DocumentTypeCode" />
						<xsl:with-param name="expresion" select="cac:InvoiceDocumentReference/cbc:DocumentTypeCode[text() !='01'and text() !='03' and text() !='05' and text() !='06' and text() !='12' and text() !='12' and text() !='13' and text() !='15' and text() !='16' and text() !='18' and text() !='21' and text() !='28' and text() !='30' and text() !='34' and text() !='37' and text() !='42' and text() !='43' and text() !='45' and text() !='55' and text() !='11' and text() !='17' and text() !='23' and text() !='24' and text() !='56' and text() !='-' and text() !='']" />					
          </xsl:call-template>
				</xsl:if>
    ...
    <xsl:param name="tipdocAfectado" select ="'-'" />
        ...
        <xsl:if test="$tipoNotaCredito = '12' ">
            <xsl:call-template name="isTrueExpresion">
                ...
                <xsl:with-param name="expresion" select="count(cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='9995' or text()='9997' or text()='9998'] and cbc:TaxableAmount &gt; 0]) &gt; 0" />
            </xsl:call-template>
        </xsl:if>
        ...
        <xsl:if test="$tipoNotaCredito = '11' ">
            <xsl:call-template name="isTrueExpresion">
                ...
                <xsl:with-param name="expresion" select="count(cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text()='9997' or text()='9998'] and cbc:TaxableAmount &gt; 0]) &gt; 0" />
            </xsl:call-template>
        </xsl:if>
    ...
    <!--xsl:variable name="totalBaseISCxLinea" select="sum($root/cac:CreditNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '2000']]/cbc:TaxableAmount)"/-->
		...
		<xsl:variable name="totalBaseISCxLinea" select="sum($root/cac:CreditNoteLine/cac:TaxTotal [ cac:TaxSubtotal [ cac:TaxCategory/cac:TaxScheme/cbc:ID [ text() = '2000' ] and cbc:TaxableAmount &gt; 0] and not(cac:TaxSubtotal [ cac:TaxCategory/cac:TaxScheme/cbc:ID [text() = '9996'] and cbc:TaxableAmount &gt; 0 ] ) ]/cac:TaxSubtotal [cac:TaxCategory/cac:TaxScheme/cbc:ID [ text() = '2000' ]]/cbc:TaxableAmount )"/>
    <xsl:choose>
       <xsl:when test="$root/cac:BillingReference/cac:InvoiceDocumentReference[cbc:DocumentTypeCode[text() = '01']]">        
          <xsl:call-template name="isTrueExpresion">
    ...
    <xsl:choose>
       ...
       <xsl:otherwise>
        ...
        <xsl:variable name="totalBaseExportacionxLinea" select="sum($root/cac:CreditNoteLine[cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '9995']]/cbc:TaxableAmount &gt; 0]/cbc:LineExtensionAmount)"/>        
        <xsl:variable name="totalBaseExportacionxLineav1" select="sum($root/cac:CreditNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '9995']]/cbc:TaxableAmount)"/>
        ...
        <xsl:variable name="totalBaseExoneradasxLinea" select="sum($root/cac:CreditNoteLine[cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '9997']]/cbc:TaxableAmount &gt; 0]/cbc:LineExtensionAmount)"/>
        <xsl:variable name="totalBaseExoneradasxLineav1" select="sum($root/cac:CreditNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '9997']]/cbc:TaxableAmount)"/>
        
        <!-- PAS20211U210700059 - Excel v7 - OBS-4297 pasa a ERR-3275-->        
        <xsl:choose>
           <xsl:when test="$tipdocAfectado ='01'">        
              <xsl:call-template name="isTrueExpresion">
        ...
        <xsl:variable name="totalBaseInafectasxLinea" select="sum($root/cac:CreditNoteLine[cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '9998']]/cbc:TaxableAmount &gt; 0]/cbc:LineExtensionAmount)"/>
        <xsl:variable name="totalBaseInafectasxLineav1" select="sum($root/cac:CreditNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '9998']]/cbc:TaxableAmount)"/>                                                                        
        ...
        <xsl:variable name="totalBaseGratuitasxLinea" select="sum($root/cac:CreditNoteLine[cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '9996']]/cbc:TaxableAmount &gt; 0]/cbc:LineExtensionAmount)"/>
        <xsl:variable name="totalBaseGratuitasxLineav1" select="sum($root/cac:CreditNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '9996']]/cbc:TaxableAmount)"/>
        ...
        <xsl:call-template name="isTrueExpresion">
            ...
            <xsl:with-param name="expresion" select="$root/cac:CreditNoteLine/cac:PricingReference/cac:AlternativeConditionPrice[cbc:PriceTypeCode ='02']/cbc:PriceAmount &gt; 0 and (cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '9996']]/cbc:TaxableAmount = 0)" />
            <!-- PAS20191U210100194 FIN JOH-->            
        </xsl:call-template>
        ...
        <!-- Excel version 5 -->
        <xsl:variable name="totalBaseIGVxLineav1" select="sum($root/cac:CreditNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '1000']]/cbc:TaxableAmount)"/>
        ...
        <!-- Excel version 5 -->
        <xsl:variable name="totalBaseIVAPxLineav1" select="sum($root/cac:CreditNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '1016']]/cbc:TaxableAmount)"/>
	...
	<xsl:template match="cac:CreditNoteLine">
        ...
        <xsl:call-template name="existAndRegexpValidateElement">
            ...
            <xsl:with-param name="node" select="cbc:ID"/>
            <xsl:with-param name="regexp" select="'^(?!0*$)\d{1,3}$'"/> <!-- enteros mayores a cero y hasta 5 digitos -->
        ...
        <xsl:if test="cbc:CreditedQuantity/@unitCode"> 
        		<xsl:call-template name="findElementInCatalog">
			         ...
			         <xsl:with-param name="idCatalogo" select="cbc:CreditedQuantity/@unitCode" />
...
<!-- 			<xsl:with-param name="regexp" select="'^(?!.*(Item Classification$)).*'"/> -->
    ...
    <xsl:choose>
		...
		ERROR 4254 -->
		<!-- PAS20191U210100194 INICIO JOH AGREGADO PRICE en el if-->
...
<!-- 	        </xsl:call-template> -->
        ...
        <!-- Se valida solo si el campo ha sido presentado PAS20201U210400041-->
        <!--xsl:call-template name="existAndValidateValueTwoDecimal"-->
        <xsl:call-template name="validateValueTwoDecimalIfExist">
        ...
        <!-- PAS20211U210700059 - Excel v7 - Se redondea las variables ValorVentaReferencialxItemCalculado y ValorVentaxItemCalculado a dos decimales, y se retira descuentos y cargos--> 
	...
	<xsl:template match="cac:TaxTotal/cac:TaxSubtotal" mode="linea">
        ...
        <xsl:if test="$codigoTributo = '9996'">
            ...
            <xsl:call-template name="isTrueExpresion">
                ...
                <xsl:with-param name="expresion" select="cbc:TaxableAmount &gt; 0.06 and cac:TaxCategory/cbc:TaxExemptionReasonCode[text() = '11' or text() = '12' or text() = '13' or text() = '14' or text() = '15' or text() = '16' or text() = '17'] and cbc:TaxAmount = 0" />
                <xsl:with-param name="descripcion" select="concat('Error en la linea: ', $nroLinea, ' Tributo: ', $codigoTributo)"/>
            </xsl:call-template>
    ...
    <xsl:choose>
        ...
        <xsl:when test="$codigoTributo = '1000' or $codigoTributo = '1016' ">
            ...
            <xsl:call-template name="isTrueExpresion">
				...
				ERROR 2040 -->
				<!-- PAS20191U210100194 INICIO JOH-->
				<xsl:if test="$codigoTributo != '7152' and cbc:TaxableAmount &gt; 0">
				<!-- <xsl:if test="$codigoTributo != '7152'"> -->
        ...
        <xsl:when test="$codigoTributo = '2000' or $codigoTributo = '9999'">
	          ...
	          <xsl:call-template name="existElement">
	             ...
	             <xsl:with-param name="descripcion" select="concat('Error en la linea: ', $nroLinea)"/>
				    ...
				    <!-- Si el Tag UBL existe, el formato del Tag UBL es diferente de decimal positivo de 3 enteros y hasta 5 decimales	ERROR 3102 
	          <xsl:call-template name="regexpValidateElementIfExist">
					     <xsl:with-param name="errorCodeValidate" select="'3102'"/>
					     <xsl:with-param name="node" select="cac:TaxCategory/cbc:Percent"/>
					     <xsl:with-param name="regexp" select="'^(?!(0)[0-9]+$)[0-9]{1,3}(\.[0-9]{1,5})?$'"/>
            ...
            <!--Excel v6 PAS20211U210400011 Se elimina la validación por redundancia-->
            <!--Versión 5 excel -->	
